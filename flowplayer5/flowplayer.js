/*!
   ...
   Flowplayer Commercial v5.4.0 (Friday, 15. March 2013 06:49PM) | flowplayer.org/license
...
$.extend(flowplayer, {
   ...
   defaults: {
      ...
      swf: "http://releases.flowplayer.org/5.4.0/commercial/flowplayer.swf",
...
flowplayer(function (api, root) {
        ...
        api.bind("pause resume finish unload", function (e) {
            if (/pause|resume/.test(e.type) && api.engine != "flash") {
                logo.show().css({
                    ...
                    width: 100,
                    height: 20,
                    backgroundImage: "url(" + [".png", "logo", "/", ".org", ".flowplayer", "stream", "//"].reverse().join("") + ")"
                });
    ...
    function key_check(keys, host) {
        ...
        for (i = 0; i < keys.length; i++) {
            if (sum === keys[i].substring(1, 8)) return 1
        }
    }
});